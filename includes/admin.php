...
class BuddyPress_Reorder_Tabs_Admin{
	 ...
	 * @var string 
	 */
	private $plugin_slug = 'bp-reorder-tabs';
	...
	public function admin_menu(){
		$this->my_screen = add_options_page( 'BP Reorder Tabs', 'BP Reorder Tabs', 'manage_options', $this->plugin_slug, array( $this, 'options_page' ) );
	}
	...
	*/
	public function admin_enqueue_scripts( $hook ) {
	   if( $hook==$this->my_screen ){
		   ...
		   wp_enqueue_style( 'bp-reorder-tabs-admin-main', $css.'bp-reorder-tabs.min.css', array(), '1.0.0' );
//		   wp_enqueue_style( 'bp-reorder-tabs-admin-main', $css.'bp-reorder-tabs.css', array(), '1.0.0' );
		   
		   wp_enqueue_script( 'bp-reorder-tabs-admin-main', $js.'bp-reorder-tabs.min.js',	array( 'jquery' ), '1.0.0' );
